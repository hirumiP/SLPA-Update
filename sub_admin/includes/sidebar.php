    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark bg-primary" id="sidenavAccordion" style="min-height:100vh;">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                -->
                <a class="nav-link d-flex align-items-center" href="item_req.php">
                    <div class="sb-nav-link-icon me-2"><i class="fas fa-map"></i></div>
                    <span>Item Requests</span>
                </a>
                <a class="nav-link d-flex align-items-center" href="print_items.php">
                    <div class="sb-nav-link-icon me-2"><i class="fas fa-print"></i></div>
                    <span>Print Item Requests</span>
                </a>
