...
<body>
    ...
    <div class="card p-4">
        ...
        <p class="card-text">
            <a href="https://www.google.com/maps?q=Sri+Lanka+Ports+Authority,Colombo"
               target="_blank" style="text-decoration: none; color: inherit;">
                Sri Lanka Ports Authority Head Office<br>
                Level 7, HQ Colombo, No. 464, T.B. Jaya Mawatha, Colombo 10
            </a>
        </p>
    </div>
</div>
...
<div class="col-md-4">
    <div class="card p-4">
        ...
        <p class="card-text">
            <a href="tel:+94112421231" style="text-decoration: none; color: inherit;">
                +94 112 42 12 31 / +94 112 42 12 01
            </a>
        </p>
    </div>
</div>
